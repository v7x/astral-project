...
Packet 16 owns full SFTP functional acceptance and integration: operation matrix, concurrency, external modifications, rename/overwrite, large files, traversal, extension policy, hardlink/symlink policy, stable errors, expiry/revocation, remote preface, rclone compatibility, readiness, and production logging.

It does not rebuild runtime closure, synthetic root, fixed workload, namespace construction, or confinement.
