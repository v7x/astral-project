...
Final implementation commit: `9542cdb2293baed5aa0d1a5bfe486c0bd2f44378`.
Final artifact SHA-256: `b729a9ed055daf7b44dbae338f67a2962775b46698bf64f87d52809e0638caeb`.
...
The artifact was built from executable source commit `9542cdb2293baed5aa0d1a5bfe486c0bd2f44378`.
...
`781`; Ubuntu 26.04 `5.0.0~beta1` / `5.0.0~beta1-0ubuntu7` / revision `817`.
...
Fresh final3 mounted runs passed nested host read, denied opaque listings, hidden
siblings, absent-parent private/overlay mutation, and lower immutability on both releases.
